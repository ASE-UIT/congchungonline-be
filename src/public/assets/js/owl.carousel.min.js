...
!(function (a, b, c, d) {
  ...
  (e.Defaults = {
            ...
            a.proxy(function (a, h) {
              return (
                c === 'left' && b > h - e && b < h + e
                  ...
                  ? (d = a + 1)
                  : this.op(b, '<', h) && this.op(b, '>', g[a + 1] || h - f) && (d = c === 'left' ? a + 1 : a),
                d === -1
              );
            }, this)
          ),
    ...
    (e.prototype.trigger = function (b, c, d, f, g) {
      ...
      const j = a.Event([b, 'owl', d || 'carousel'].join('.').toLowerCase(), a.extend({ relatedTarget: this }, h, c));
      return (
        this._supress[b] ||
        ...
        !e ||
          ...
          (e.each(
            a.proxy(function (c, d) {
              let e;
              const f = a(d);
              const g = (b.devicePixelRatio > 1 && f.attr('data-src-retina')) || f.attr('data-src');
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (e.prototype.thumbnail = function (b, c) {
        ...
        let e;
        let f;
        const g = c.width && c.height ? `style="width:${c.width}px;height:${c.height}px;"` : '';
        const h = b.find('img');
        let i = 'src';
        let j = '';
      ...
      (e.prototype.play = function (b) {
        ...
        this._playing ||
          ...
          f.type === 'youtube'
            ...
            : f.type === 'vzaar' &&
              (c = `<iframe frameborder="0"height="${h}"width="${g}" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/${f.id}/player?autoplay=true"></iframe>`),
          ...
          'changed.owl.carousel': a.proxy(function (a) {
            a.namespace && a.property.name === 'settings'
              ? this._core.settings.autoplay
                ? this.play()
                : this.stop()
              : a.namespace && a.property.name === 'position' && this._core.settings.autoplay && this._setAutoPlayInterval();
          }, this),
          'initialized.owl.carousel': a.proxy(function (a) {
