...
!(function (a) {
  ...
  (t.prototype = {
    ...
    updateStatus(a, d) {
      if (b.preloader) {
        c !== a && b.container.removeClass(`mfp-s-${c}`), d || a !== 'loading' || (d = b.st.tLoading);
          ...
          L && clearInterval(L),
            (L = setInterval(function () {
              return d.naturalWidth > 0
                ...
                : (c > 200 && clearInterval(L), c++, void (c === 3 ? e(10) : c === 40 ? e(50) : c === 100 && e(500)));
            }, f));
        };
        e(1);
      },
            ...
            ? ((f += ' mfp-gallery'),
              ...
              w(`BuildControls${e}`, function () {
                if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
                  ...
                  const e = (b.arrowLeft = a(d.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, 'left')).addClass(s));
                  const f = (b.arrowRight = a(d.replace(/%title%/gi, c.tNext).replace(/%dir%/gi, 'right')).addClass(s));
                  e.click(function () {
                    b.prev();
                  }),
                    f.click(function () {
