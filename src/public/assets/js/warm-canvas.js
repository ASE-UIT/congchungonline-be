...
(function () {
    $.glassyWorms = {
        ...
        setup: function () {
            ...
            _results = [];
            for (
                i = _i = 0, _ref = this.glassyWormsOptins.numParticles;
                _i <= _ref;
                i = _i += 1
            ) {
                x = random(this.width);
                ...
                _results.push(
                    this.particles.push(
                        new $.glassyWorms.Particle(
                            x,
                            y,
                            m,
                            this.glassyWormsOptins.colors
                        )
                    )
                );
            }
        ...
        draw: function () {
            ...
            for (
                ...
                for (
                    j = _j = _ref1 = i + 1,
                        _ref2 = this.glassyWormsOptins.numParticles;
                    _j <= _ref2;
                    j = _j += 1
                ) {
                    b = this.particles[j];
                    ...
                    if (dst >= rad) {
                        ...
                        fy = dy * len;
                        f = min(
                            this.glassyWormsOptins.maxForce,
                            (this.glassyWormsOptins.gravity * a.mass * b.mass) /
                                dSq
                        );
                        a.fx += f * fx * b.charge;
                        a.fy += f * fy * b.charge;
    ...
    $.fn.glassyWorms = function (options) {
        ...
        if (typeof options === "string") {
            this.each(function (index, el) {
                ...
                console.log(
                    el.glassyWorms,
                    (_ref = el.glassyWorms) != null ? _ref[options] : void 0
                );
